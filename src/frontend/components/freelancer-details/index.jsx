            ...
            <div className="row align-right mt-5">
              <div className="col-lg-8 col-md-12">
                <div className="developer-box head-develop">
                  ...
                  <h2>
                    John Danie S <i className="fas fa-check-circle" />
                  </h2>
                  <p>
                    iOS Expert + Node Dev <span>Full time</span>
                  </p>
                  <ul className="develope-list-rate">
                    ...
                    <li className="bl-0">
                      <img src={pl} alt="" height={16} /> Poland
                    </li>
                  </ul>
                  ...
                  <ul className="feed-back-detail">
                    <li>
                      Recommended<span>89%</span>
                    </li>
                    <li>
                      Completed Projects<span>22</span>
                    </li>
                    <li>
                      Clients<span>48</span>
                    </li>
                    <li>
                      Ongoing Projects<span>2</span>
                    </li>
                    <li>
                      Feedbacks<span>5</span>
                    </li>
                    <li>
                      Rehired<span>12</span>
                    </li>
                  </ul>
                </div>
                <div className="pro-view develop-view">
                  ...
                  <div className="pro-post widget-box" id="overview">
                    ...
                    <div className="pro-content">
                      ...
                      <p>
                        ...
                        consectetur adipiscing elit. Quisque tempor aliquam
                        felis, nec condimentum ipsum commodo id. Vivamus sit
                        amet augue nec urna efficitur tincidunt. Vivamus
                        consectetur aliquam lectus commodo viverra. Nunc eu
                  ...
                  <div
                    className="pro-post project-widget widget-box develop-experiance"
                    id="experience"
                  >
                      ...
                      <div className="row">
                        <div className="col-lg-4 col-md-6 d-flex">
                          <div className="experiance-list">
                            ...
                            <h4>Logo Designer</h4>
                            <h5>
                              Techline <br /> July 9, 2018 - March 18, 2021
                            </h5>
                            <p>
                        ...
                        <div className="col-lg-4 col-md-6 d-flex">
                          <div className="experiance-list">
                            ...
                            <h4>UI Designer</h4>
                            <h5>
                              Techline <br /> May 10, 2020 - March 10, 2022
                            </h5>
                            <p>
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Donec eget vestibulum lorem. Lorem ipsum
                              dolor sit amet, consectetur adipiscing elit.
                              Quisque tempor aliquam felis
                            </p>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-6 d-flex">
                          <div className="experiance-list">
                            ...
                            <h4>UX Designer</h4>
                            <h5>
                              Techline <br /> Sep 10, 2018 - Jan 18, 2020
                            </h5>
                            <p>
                              Lorem ipsum dolor sit amet ,nec condimentum ipsum
                              commodo id. Vivamus sit amet augue nec urna
                  ...
                  <div
                    className="pro-post author-widget clearfix develop-feedback"
                    id="feedback"
                  >
                    <div className="widget-title-box clearfix d-flex">
                      <h3 className="pro-title mb-0">Feedbacks</h3>
                      <Link to="#" className="feedback-view">
                        View All
                      </Link>
                    </div>
                    <div className="about-author">
                      <div className="about-author-img">
                        <div className="author-img-wrap">
                          <Link to="#">
                            <img className="img-fluid" alt="" src={Img_003} />
                          </Link>
                        </div>
                      </div>
                    ...
                    <div className="about-author">
                      <div className="about-author-img">
                        <div className="author-img-wrap">
                          <Link to="#">
                            <img className="img-fluid" alt="" src={Img_004} />
                          </Link>
                        </div>
                      </div>
                      <div className="author-details">
                    ...
                    <div className="about-author">
                      <div className="about-author-img">
                        <div className="author-img-wrap">
                          <Link to="#">
                            <img className="img-fluid" alt="" src={Img_005} />
                          </Link>
                        </div>
                      </div>
                      <div className="author-details">
