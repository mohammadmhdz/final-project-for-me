          ...
          <div className="three-dots">
            ...
            <div className="dropdown-menu user-menu-list">
              <Link
                ...
                data-bs-target="#transaction-category"
              >
                <img className="me-2 " src={icon_01} alt="" /> View Details
              </Link>
              <Link className="dropdown-item" to="/admin/user-profile">
                <img className="me-2 " src={icon_05} alt="" /> User Profile
              </Link>
              <Link className="dropdown-item" to="#">
                <img className="me-2 " src={icon_06} alt="" /> Approve
              </Link>
              <Link className="dropdown-item mb-0" to="#">
                <img className="me-2 " src={icon_07} alt="" /> Reject{" "}
              </Link>
            </div>
          </div>
        </>
