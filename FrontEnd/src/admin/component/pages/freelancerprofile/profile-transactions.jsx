...

    {
      ...
      render: (text, record) => (
        <>
          <button
            className={` ${
              record.details === "Recived"
                ? "btn received-btn"
                : "btn withdraw-btn text-danger"
            }`}
          >
            {text}
          </button>
                    ...
                    <ul>
                      <li>
                        <Link to="/admin/user-profile">
                          <img className="me-2" src={icon_12} alt="" />
                          Personal{" "}
                        </Link>
                      </li>
                      <li className="active">
                        <Link to="/admin/profile-transactions">
                          <img className="me-2" src={icon_10} alt="" />
                          Transactions{" "}
                        </Link>
                      </li>
                      <li>
                        <Link to="/admin/activities">
                          <img className="me-2" src={icon_11} alt="" />
                          Activities
                        </Link>
                      </li>
                    </ul>
