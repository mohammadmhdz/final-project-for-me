                      ...
                      <ul className="activity-feed">
                        <li className="feed-item">
                          ...
                          <span className="feed-text">
                            <Link to="/admin/profile">Brian Johnson</Link> has
                            paid the invoice{" "}
                            <Link to="/admin/view-invoice">"#CD41544"</Link>
                          </span>
                        </li>
                        <li className="feed-item">
                          <div className="feed-date">Nov 7</div>
                          <span className="feed-text">
                            <Link to="/admin/profile">Marie Canales</Link> has
                            accepted your estimate{" "}
                            <Link to="/admin/view-estimate">#GTR14544</Link>
                          </span>
                        </li>
                        <li className="feed-item">
                          ...
                          <span className="feed-text">
                            <Link to="/admin/profile">Brian Johnson</Link> has
                            paid the invoice{" "}
                            <Link to="/admin/view-invoice">"#CD42565"</Link>
                          </span>
                        </li>
                        <li className="feed-item">
                          ...
                          <span className="feed-text">
                            <Link to="/admin/profile">Marie Canales</Link> has
                            accepted your estimate{" "}
                            <Link to="/admin/view-estimate">#GTR422385</Link>
                          </span>
                        </li>
                        <li className="feed-item">
                          ...
                          <span className="feed-text">
                            <Link to="/admin/profile">Brian Johnson</Link> has
                            paid the invoice{" "}
                            <Link to="/admin/view-invoice">"#CD6988"</Link>
                          </span>
                        </li>
                        <li className="feed-item">
                          ...
                          <span className="feed-text">
                            <Link to="/admin/profile">Marie Canales</Link> has
                            accepted your estimate{" "}
                            <Link to="/admin/view-estimate">#GTR569231</Link>
                          </span>
                        </li>
                      </ul>
                    </div>
