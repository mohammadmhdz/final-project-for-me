  ...
  const data = [
    {
      ...
      verified: (
        <div className="verify-mail">
          <FeatherIcon
            icon="check-circle"
            className="feather ms-1 text-success"
          />
          Email{" "}
        </div>
      ),
    ...
    },
    {
      ...
      verified: (
        <div className="verify-mail">
          <FeatherIcon icon="check-circle" className="me-1 email-check" />
          Email{" "}
        </div>
      ),
                ...
                <div className="col-sm-12">
                  <div className="subscribe-employe users-list">
                    <ul>
                      ...
                      <li>
                        <Link to="/admin/user-inactive">غیرفعال</Link>
                      </li>
                      <li>
                        <Link to="/admin/user-suspended">حذف شده</Link>
                      </li>
                      <li>
                        <Link className="active" to="/admin/user-administrator">
                          ادمین ها
                        </Link>
                      </li>
                    </ul>
