      ...
      render: (text, record) => (
        <>
          <Link
            to="#"
            className={` ${
              record.status === "تکمیل شده" ? "user-active-btn" : "text-danger"
            }`}
          >
            {text}
          </Link>
        ...
        <>
          <div className="three-dots">
            ...
            <div className="dropdown-menu user-menu-list">
              ...
              >
                <img className="me-2 " src={icon_01} alt="" /> مشاهده جزییات
              </Link>
              <Link className="dropdown-item" to="/admin/user-profile">
                <img className="me-2 " src={icon_05} alt="" /> پروفایل کاربر
              </Link>
              {/* <Link className="dropdown-item" to="#">
                <img className="me-2 " src={icon_06} alt="" /> تایید کردن
              </Link>
              <Link className="dropdown-item mb-0" to="#">
                <img className="me-2 " src={icon_07} alt="" /> رد کردن{" "}
              </Link> */}
            </div>
          </div>
        </>
            ...
            <div className="content report-box container-fluid">
              ...
              <div className="page-header subscribe-head border-bottom-0">
                <div className="row align-items-center">
                  <div className="col">
                    <h3 className="page-title">واریز ها</h3>
                  </div>
                </div>
              </div>
              {/* /Page Header */}
              <div className="row">
                <div className="col-sm-12">
                  <div className="subscribe-employe users-list">
                    <ul>
                      <li className="active">
                        <Link to="/admin/withdrawn">همه </Link>
                      </li>

                      <li>
                        <Link to="/admin/withdrawn-cancelled">لغو شده</Link>
                      </li>
                      <li>
                        <Link to="/admin/withdrawn-completed">تکمیل شده</Link>
                      </li>
                    </ul>
                  </div>
                  {/* Active User Header */}
                  <div className="page-header user-active">
                    <div className="row align-items-center">
                      <div className="col">
                        <h3 className="page-title">همه واریز ها</h3>
                        <p>
                          در مجموع <span>57</span> تراکنش
                        </p>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <ul className="paginations list-pagination text-end mb-4">
                        <li>
                          <Link to="#">
                            <i className="fas fa-angle-left" /> قبلی
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="#">
                            بعدی <i className="fas fa-angle-right" />
                          </Link>
                        </li>
                      </ul>
                    </div>
