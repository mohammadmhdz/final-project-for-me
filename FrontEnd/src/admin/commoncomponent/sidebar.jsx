            ...
            <div id="sidebar-menu" className="sidebar-menu">
              <ul>
                ...
                <li className={pathname === "/admin/index" ? "active" : ""}>
                  <Link to="/admin/index">
                    <FeatherIcon icon="home" /> <span>داشبورد</span>
                  </Link>
                </li>
                <li
                ...
                >
                  <Link to="/admin/categories">
                    <FeatherIcon icon="copy" /> <span>دسته بندی ها</span>
                  </Link>
                </li>
                <li className={pathname === "/admin/projects" ? "active" : ""}>
                  <Link to="/admin/projects">
                    <FeatherIcon icon="database" /> <span>فرصت های شغلی</span>
                  </Link>
                </li>
                <li
                  className={
                ...
                >
                  <Link to="/admin/users">
                    <FeatherIcon icon="users" /> <span>کارجویان</span>
                  </Link>
                </li>
                <li
                  className={
                ...
                >
                  {/* <Link to="/admin/deposit">
                    <FeatherIcon icon="user-check" /> <span>برداشت</span>
                  </Link> */}
                </li>
                <li
                  className={
                ...
                >
                  <Link to="/admin/withdrawn">
                    <FeatherIcon icon="user-check" /> <span>واریز</span>
                  </Link>
                </li>
                <li
                  className={
                ...
                >
                  {/* <Link to="/admin/transaction">
                    <FeatherIcon icon="clipboard" /> <span>تراکنش ها</span>
                  </Link> */}
                </li>
                <li className={pathname === "/admin/providers" ? "active" : ""}>
                  <Link to="/admin/providers">
                    <FeatherIcon icon="user-check" /> <span>شرکت ها</span>
                  </Link>
                </li>
                <li
                  className={
                ...
                >
                  <Link to="/admin/subscription">
                    <FeatherIcon icon="user-check" /> <span>اشتراک</span>
                  </Link>
                </li>
