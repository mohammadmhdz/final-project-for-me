                      ...
                      <div className="profile-info profile-edit-form">
                        ...
                        <div className="pro-text3">
                          ...
                          <ul className="profile-preword">
                            <li>
                              <img src={Flags_pl} alt="" height={16} /> Poland
                            </li>
                            <li>
                  ...
                  <ul className="nav nav-tabs nav-tabs-solid nav-justified">
                    ...
                    <li className="nav-item">
                      <a
                        ...
                        data-bs-toggle="tab"
                      >
                        <img alt="User Image" height={28} src={Tab_icon_06} />
                      ...
                      <div className="pro-overview">
                        <div className="pro-content">
                          <div className="pro-text1">
                            ...
                            <p>
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Donec eget vestibulum lorem. Lorem ipsum
                              dolor sit amet, consectetur adipiscing elit.
                              Quisque tempor aliquam felis, nec condimentum
                          ...
                          <div className="pro-new1">
                            ...
                            >
                              ...
                              <p>
                                ...
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Quisque tempor aliquam felis,
                                nec condimentum ipsum commodo id. Vivamus sit
                                amet augue nec urna efficitur tincidunt. Vivamus
                                consectetur aliquam lectus commodo viverra. Nunc
                                eu augue nec arcu efficitur faucibus.
                              </p>
                              <h4 className="widget-title">
                                My services include:
                              </h4>
                              <ul className="pro-list">
                                ...
                                <li>Re-skin</li>
                                <li>
                                  Ads and in-app purchase (Maximize your
                                  Revenue)
                                </li>
                                <li>Game Optimisations</li>
                                <li>2D/3D Animation</li>
                              ...
                              <p>
                                Graphic DesigningSocial Network
                                IntegrationVirtual Reality (VR)Augmented Reality
                                (AR)Game con promotional graphics and video app
                                store and Playstore publishing{" "}
                              </p>
                              <div className="row">
                          ...
                          <ul className="clearfix pro-text">
                            <li>
                              ...
                              <p>
                                ...
                                more than 10-years of experience in graphics
                                design. If you are looking for any graphic
                            ...
                            <li>
                              ...
                              <p>
                                I am a professional graphic designer. I have
                                more than 8-years of experience in graphics
                                design. If you are looking for any graphic
                                related work, contact me, I'll glad to help you.
                              </p>
                            </li>
                            <li>
                              ...
                              <p>
                                I am a professional graphic designer. I have
                                more than 5-years of experience in graphics
                                design. If you are looking for any graphic
                                related work, contact me, I'll glad to help you.
                              </p>
                            </li>
                          ...
                          <div className="pro-text2">
                            <ul className="clearfix">
                              <li>
                                ...
                                <h5>
                                  Hampshire University January 12, 2015 -
                                  January 19, 2019
                                </h5>
                                <p>
                                  Graphic Designing artworks through making
                                  plans and utilizing the helpful analysis of
                                  companions, educators, and bosses to improve
                                  those plans. Careful discipline brings about
                                  promising results, and the capacity to
                                  acknowledge and gain from analysis from peers
                                  and even the purchaser everywhere is pivotal
                                  for accomplishment in this field.
                                </p>
                              </li>
                              <li>
                                ...
                                <p>
                                  ...
                                  more than 10-years of experience in graphics
                                  design. If you are looking for any graphic
                                  related work, contact me, I'll glad to help
                                  you.
                                </p>
                              </li>
                            </ul>
                                ...
                                <div className="freelance-content">
                                  ...
                                  <div className="author-heading">
                                    ...
                                    <div className="freelance-info">
                                      ...
                                      <div className="freelance-location mb-1">
                                        <i className="fas fa-clock" /> Posted 1
                                        min ago
                                      </div>
                                      <div className="freelance-location">
                                        <i className="fas fa-map-marker-alt me-1" />
                                ...
                                <div className="freelance-content">
                                  ...
                                  <div className="author-heading">
                                    ...
                                    <div className="freelance-info">
                                      ...
                                      <div className="freelance-location mb-1">
                                        <i className="fas fa-clock" /> Posted 3
                                        days ago
                                      </div>
                                      <div className="freelance-location">
                                        <i className="fas fa-map-marker-alt me-1" />
                    ...
                    <div className="pro-post project-widget">
                      ...
                      <div className="widget-box">
                        <div className="pro-post billing-method">
                          <p className="mb-0">
                            Add Billing Method{" "}
                            <a href="#" className="add-bill float-end">
                      ...
                      <div className="transaction">
                        <img className="img-fluid" alt="" src={Redeem_icon} />
